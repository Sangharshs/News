...
public class GoogleDocFragment extends Fragment {


    public GoogleDocFragment() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        v=inflater.inflate(R.layout.fragment_google_doc, container, false);
        ...
        call.enqueue(new Callback<List<Ebook>>() {
            ...
            public void onResponse(Call<List<Ebook>> call, Response<List<Ebook>> response) {
                ...
                if (response.isSuccessful()){
                    ...
                    EbookAdapter adapter = new EbookAdapter(subcategoryList,v.getContext());
